...
// Download
class themeplace_Widget_download extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Download', 'themeplace' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'download_section',
         [
            'label' => esc_html__( 'Download', 'themeplace' ),
      ...
      $this->add_control(
         'ppp',
         [
            'label' => __( 'Number of Items', 'themeplace' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new themeplace_Widget_download );