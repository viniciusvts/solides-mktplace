...
// Newest Item
class themeplace_Widget_Newest extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Newest', 'themeplace' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'newest_section',
         [
            'label' => esc_html__( 'Newest', 'themeplace' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new themeplace_Widget_Newest );